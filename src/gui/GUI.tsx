                     ...
                     {activeKey === "printer" && (
                        <div className="printer-panel">
                           ...
                           <div className="retro-hint">
                              The Laser 500 includes a Centronics-compatible parallel printer interface mapped to I/O port <strong>00h</strong> (Status / Ready), port <strong>0Eh</strong> (8-bit Data latch), and port <strong>0Dh</strong> (Strobe trigger).<br />
